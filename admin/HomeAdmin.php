    ...
    <div class="middle">
        <div class="container">
            <div class="mySlides">
                ...
                <img src="../img/Style1.jpg" style="width:50%" height="70%">
            </div>

            <div class="mySlides">
                <div class="numbertext">2 / 6</div>
                <img src="../img/Style2.jpg" style="width:50%" height="70%">
            </div>

            <div class="mySlides">
                <div class="numbertext">3 / 6</div>
                <img src="../img/Style3.jpg" style="width:50%" height="70%">
            </div>

            <div class="mySlides">
                <div class="numbertext">4 / 6</div>
                <img src="../img/Style4.jpg" style="width:50%" height="70%">
            </div>

            <div class="mySlides">
                <div class="numbertext">5 / 6</div>
                <img src="../img/Style5.jpg" style="width:50% " height="70%">
            </div>

            <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                <img src="../img/Style6.jpg" style="width:50%" height="70%">
            </div>
